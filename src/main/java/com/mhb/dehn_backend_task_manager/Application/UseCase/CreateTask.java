...
public final class CreateTask {
    ...
    public Task execute(String title, String description, String dueDate) throws IOException, ParseException {
        return this.taskRepository.create(title, description, dueDate);
    }
}
